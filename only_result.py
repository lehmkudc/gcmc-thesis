...
parser.add_argument("-e", "--n_equil", action = "store", dest="n_equil",type=int, default = 5000)
parser.add_argument("-o", "--n_prod", action = "store", dest="n_prod",type=int, default = 1000)
